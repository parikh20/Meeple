...
/**
 * This class is a generic way of backing an RecyclerView with a Firebase and GeoFire location.
 * It handles all of the value events at the specified child (by key) at the given Firebase location.
...
public abstract class GeoFireRecyclerAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    GeoFireArray<T> mSnapshots;
    DatabaseReference mModelDatabaseRef;
     ...
     * @param modelDatabaseRef The Firebase location to watch for data changes. Can also be a slice of a location, using some
     *                   combination of <code>limit()</code>, <code>startAt()</code>, and <code>endAt()</code>
     */
    public GeoFireRecyclerAdapter(Class<T> modelClass, int modelLayout, Class<VH> viewHolderClass,
                                  DatabaseReference modelDatabaseRef, GeoQuery geoQuery) {
        mModelClass = modelClass;
        mModelLayout = modelLayout;
        mViewHolderClass = viewHolderClass;
        mModelDatabaseRef = modelDatabaseRef;
        mSnapshots = new GeoFireArray<T>(geoQuery, modelDatabaseRef, modelClass);

        mSnapshots.setOnChangedListener(new GeoFireArray.OnChangedListener() {
            @Override
